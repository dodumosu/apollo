...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(70:6) {#if participant === null}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 68, 4, 1781);
    			attr_dev(div1, "class", "row h-75 align-items-center");
    			add_location(div1, file, 67, 2, 1735);
    			attr_dev(main, "class", "container h-100");
    			add_location(main, file, 66, 0, 1702);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
