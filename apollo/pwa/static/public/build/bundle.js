...
var app = (function () {
    ...
    class APIClient {
        ...
        getForms = events => {
            const endpoint = (events === [] || events === null || events === undefined) ? this.endpoints.list : `${this.endpoints.list}?events=${events.join(',')}`;
    ...
    /* src/components/LoginForm.svelte generated by Svelte v3.34.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = text(t8_value);
    			attr_dev(h5, "class", "card-header");
    			add_location(h5, file$2, 21, 20, 457);
    			attr_dev(label0, "for", "participant_id");
    			attr_dev(label0, "class", "visually-hidden");
    			add_location(label0, file$2, 24, 28, 627);
    			...
    			add_location(input0, file$2, 25, 28, 750);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$2, 23, 24, 580);
    			attr_dev(label1, "for", "password");
    			attr_dev(label1, "class", "visually-hidden");
    			add_location(label1, file$2, 28, 28, 997);
    			...
    			add_location(input1, file$2, 29, 28, 1108);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file$2, 27, 24, 950);
    			attr_dev(button, "class", "btn btn-primary");
    			button.disabled = !navigator.onLine;
    			add_location(button, file$2, 33, 32, 1400);
    			attr_dev(div2, "class", "d-grid gap-2");
    			add_location(div2, file$2, 32, 28, 1341);
    			attr_dev(div3, "class", "mb-3");
    			add_location(div3, file$2, 31, 24, 1294);
    			attr_dev(div4, "class", "card-body");
    			add_location(div4, file$2, 22, 20, 532);
    			attr_dev(div5, "class", "card shadow-sm");
    			add_location(div5, file$2, 20, 16, 408);
    			add_location(form, file$2, 19, 12, 385);
    			attr_dev(div6, "class", "form-signin");
    			add_location(div6, file$2, 18, 8, 347);
    			attr_dev(div7, "class", "col");
    			add_location(div7, file$2, 17, 4, 321);
    			attr_dev(div8, "class", "row");
    			add_location(div8, file$2, 16, 0, 299);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", prevent_default(/*handleLogin*/ ctx[3]), false, true, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const handleLogin = () => {
    		dispatch("authenticate", { participant_id, password });
    	};
    ...
    /* src/components/UserInfo.svelte generated by Svelte v3.34.0 */
    const file$1 = "src/components/UserInfo.svelte";

    // (39:16) {#if pendingSubmissions && pendingSubmissions > 0 }
    function create_if_block$1(ctx) {
    	let div2;
    	let div1;
    	let div0;
    	let t0_value = /*i18n*/ ctx[0].gettext("Pending submissions:") + "";
    	let t0;
    	let t1;
    	let strong;
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(/*pendingSubmissions*/ ctx[2]);
    			add_location(strong, file$1, 41, 99, 1713);
    			attr_dev(div0, "class", "alert alert-info");
    			add_location(div0, file$1, 41, 28, 1642);
    			attr_dev(div1, "class", "col");
    			add_location(div1, file$1, 40, 24, 1596);
    			attr_dev(div2, "class", "row");
    			add_location(div2, file$1, 39, 20, 1554);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*i18n*/ 1 && t0_value !== (t0_value = /*i18n*/ ctx[0].gettext("Pending submissions:") + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*pendingSubmissions*/ 4) set_data_dev(t2, /*pendingSubmissions*/ ctx[2]);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(39:16) {#if pendingSubmissions && pendingSubmissions > 0 }",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let div6;
    	let button;
    	let t12_value = /*i18n*/ ctx[0].gettext("Click here") + "";
    	let t12;
    	let t13;
    	let t14_value = /*i18n*/ ctx[0].gettext("if this is not you.") + "";
    	let t14;
    	let t15;
    	let mounted;
    	let dispose;
    	let if_block = /*pendingSubmissions*/ ctx[2] && /*pendingSubmissions*/ ctx[2] > 0 && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$1, 26, 16, 696);
    			add_location(strong0, file$1, 28, 39, 844);
    			attr_dev(div0, "class", "col-4");
    			add_location(div0, file$1, 28, 20, 825);
    			attr_dev(div1, "class", "col");
    			add_location(div1, file$1, 29, 20, 922);
    			attr_dev(div2, "class", "row mb-3");
    			add_location(div2, file$1, 27, 16, 782);
    			add_location(strong1, file$1, 32, 39, 1077);
    			attr_dev(div3, "class", "col-4");
    			add_location(div3, file$1, 32, 20, 1058);
    			attr_dev(div4, "class", "col");
    			add_location(div4, file$1, 33, 20, 1149);
    			attr_dev(div5, "class", "row mb-3");
    			add_location(div5, file$1, 31, 16, 1015);
    			attr_dev(button, "class", "btn btn-outline-dark");
    			add_location(button, file$1, 36, 37, 1296);
    			attr_dev(div6, "class", "col");
    			add_location(div6, file$1, 36, 20, 1279);
    			attr_dev(div7, "class", "row mb-3");
    			add_location(div7, file$1, 35, 16, 1236);
    			attr_dev(div8, "class", "card-body");
    			add_location(div8, file$1, 25, 12, 656);
    			attr_dev(div9, "class", "card shadow-sm");
    			add_location(div9, file$1, 24, 8, 615);
    			attr_dev(div10, "class", "col");
    			add_location(div10, file$1, 23, 4, 589);
    			attr_dev(div11, "class", "row");
    			add_location(div11, file$1, 22, 0, 567);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*handleLogout*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*i18n*/ 1 && t12_value !== (t12_value = /*i18n*/ ctx[0].gettext("Click here") + "")) set_data_dev(t12, t12_value);
    			if (dirty & /*i18n*/ 1 && t14_value !== (t14_value = /*i18n*/ ctx[0].gettext("if this is not you.") + "")) set_data_dev(t14, t14_value);

    			if (/*pendingSubmissions*/ ctx[2] && /*pendingSubmissions*/ ctx[2] > 0) {
    				if (if_block) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [i18n, participant, pendingSubmissions, greeting, handleLogout];
    }
    ...
    class UserInfo extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*i18n*/ ctx[0] === undefined && !("i18n" in props)) {
    			console.warn("<UserInfo> was created without expected prop 'i18n'");
    		}

    		if (/*participant*/ ctx[1] === undefined && !("participant" in props)) {
    			console.warn("<UserInfo> was created without expected prop 'participant'");
    		}

    		if (/*pendingSubmissions*/ ctx[2] === undefined && !("pendingSubmissions" in props)) {
    			console.warn("<UserInfo> was created without expected prop 'pendingSubmissions'");
    		}
    	}
    ...
    function create_else_block(ctx) {
    	...
    	userinfo.$on("logout", /*onLogout*/ ctx[3]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*participant*/ 1) userinfo_changes.participant = /*participant*/ ctx[0];
    ...
    function create_if_block(ctx) {
    	...
    	loginform.$on("authenticate", /*onAuthenticate*/ ctx[2]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(66:12) {#if participant === null}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 60, 33, 2132);
    			attr_dev(div0, "class", "container-fluid");
    			add_location(div0, file, 60, 4, 2103);
    			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark fixed-top-mb-6");
    			add_location(nav, file, 59, 0, 2026);
    			attr_dev(div1, "class", "col-sm-10 offset-sm-1 mt3");
    			add_location(div1, file, 64, 8, 2274);
    			attr_dev(div2, "class", "row h-75 align-items-center");
    			add_location(div2, file, 63, 4, 2224);
    			attr_dev(main, "class", "container h-100");
    			add_location(main, file, 62, 0, 2189);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const onAuthenticate = event => {
    		notiflixAio2_7_0_min.Loading.Standard(i18n$1.gettext("Please wait"));

    		apiClient.authenticate(event.detail.participant_id, event.detail.password).then(result => {
    			notiflixAio2_7_0_min.Loading.Remove();

    			if (result.status === 200) {
    				result.payload.then(data => {
    					$$invalidate(0, participant = data.data.participant);
    					$$invalidate(0, participant.lastLogin = new Date(), participant);
    					localDatabase.saveParticipant(participant);
    				});
    			} else {
    				notiflixAio2_7_0_min.Report.Failure(i18n$1.gettext("Error"), i18n$1.gettext("Please check your credentials and try again"), i18n$1.gettext("OK"));
    			}
    		}).catch(() => {
    			notiflixAio2_7_0_min.Loading.Remove();
    			notiflixAio2_7_0_min.Report.Failure(i18n$1.gettext("Error"), i18n$1.gettext("There was an error trying to log you in"), i18n$1.gettext("OK"));
    		});
    	};

    	const onLogout = () => {
    		apiClient.logout(get("crsf_access_token")).then(() => {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("submissions" in $$props) submissions = $$props.submissions;
    	};
    	...
    	return [participant, i18n$1, onAuthenticate, onLogout, endpoints];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { endpoints: 4 });
    		...
    		if (/*endpoints*/ ctx[4] === undefined && !("endpoints" in props)) {
    			console.warn("<App> was created without expected prop 'endpoints'");
    		}
    	}
